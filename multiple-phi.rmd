...
This is only possible due to the conditional independence between individuals in the posterior, and Appendix&nbsp;\ref{one-at-a-time} contains the details of this scheme.
