...
The key advantage of these ideas is that development and validation is easier, or sometimes only possible, because submodels are smaller and relate to only one source of data.
