...
- Other advantages to modularised inference
    - understand submodels on their own and when they are combined
    - use multiple software packages, which means we can reuse other implementations
    - reuse posterior samples / computations 

## Advantages - for introduction?
