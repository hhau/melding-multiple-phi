\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption{A DAG of the submodels and their common quantities, with the parallel sampling strategy overlaid. The stage one ($s_{1}$) targets are in blue; stage two ($s_{2}$) target is in red.}
