\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption{The same DAG as Figure \ref{fig:intro-dag}, with the sequential sampling strategy overlaid. The stage one target ($s_{1}$) is encapsulated in the light blue dashed line; stages two and three ($s_{2}, s_{3}$) are in dark blue and red respectively.}
