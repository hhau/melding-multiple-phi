\begin{figure}[tb]
  ...
  \end{tikzpicture}
  \caption{An arbitrary graph connected by common quantities $\phi_{\modelindex : \modelindex'}$. The bounding boxes represent the models considered in stage $s_{\modelindex}$ of the multi-stage sampler.}
