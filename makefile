...
SUBPOSTERIOR_PLOT_PATCHWORK = $(OWLS_PLOTS)/subposteriors-both-patchwork.pdf

$(SUBPOSTERIOR_PLOT) \
$(SUBPOSTERIOR_PLOT_MELDING_ONLY) \
$(SUBPOSTERIOR_PLOT_PATCHWORK) &: \
	$(OWLS_SCRIPTS)/plot-subposteriors.R \
	$(PLOT_SETTINGS) \
	$(MCMC_UTIL) \
	$(ORIG_IPM_SAMPLES) \
	$(FECUNDITY_SUBPOSTERIOR) \
	$(CAPTURE_RECAPTURE_SUBPOSTERIOR) \
	$(COUNT_DATA_SUBPOSTERIOR) \
	$(MELDED_POSTERIOR) \
	$(NORMAL_APPROX_MELDED_POSTERIOR) \
	$(MELDED_POSTERIOR_PHI_LOG_POOLING) \
	$(MELDED_POSTERIOR_PHI_LIN_POOLING)
		$(RSCRIPT) $<

ALL_PLOTS += $(SUBPOSTERIOR_PLOT) $(SUBPOSTERIOR_PLOT_MELDING_ONLY) $(SUBPOSTERIOR_PLOT_PATCHWORK)
