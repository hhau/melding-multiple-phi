...
SURV_STAGE_TWO_PHI_SAMPLES = $(SURV_RDS)/stage-two-phi-samples.rds
SURV_STAGE_TWO_PSI_SAMPLES = $(SURV_RDS)/stage-two-psi-samples.rds
SURV_STAGE_TWO_INDICES = $(SURV_RDS)/stage-two-indices.rds

$(SURV_STAGE_TWO_PHI_SAMPLES) : $(SURV_SCRIPTS)/fit-stage-two.R $(SURV_SUBMODEL_ONE_OUTPUT) $(SURV_SUBMODEL_TWO_SIMULATED_DATA) $(SURV_STAGE_TWO_STAN_MODELS) $(SURV_GLOBAL_SETTINGS)
	$(RSCRIPT) $<

$(SURV_STAGE_TWO_PSI_SAMPLES) : $(SURV_STAGE_TWO_PHI_SAMPLES)

$(SURV_STAGE_TWO_INDICES) : $(SURV_STAGE_TWO_PHI_SAMPLES)
