...
flog.info("surv-fit-linear-measurement-model: compiling model")
...
flog.info("surv-fit-linear-measurement-model: fitting model")
...
flog.info("surv-fit-linear-measurement-model: saving output")
