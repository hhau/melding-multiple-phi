...
We agree that this sentence was fuzzy, however the following sentence referred to the appendix that contains all relevant details. Such details are extensive and unsuitable for inclusion in the main text. We have eluded to the detail of said appendix in the revised version of the final sentences in the first paragraph of Section 5.5, which read
...
Many two-stage methods make use of this practical equivalence [@lunn:etal:13; @mauff_joint_2020; @tom:etal:10; @blomstedt:etal:19; @hooten_making_2019] even considering the potential for this type of bias.
