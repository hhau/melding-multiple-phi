...
- "_The proposed chained marginal replacement operation modifies the submodels to enforce that they share a common prior for $\boldsymbol{\phi}$. This consistency allows us to use Markov combination to unite the submodels._"
